...
public class ModelMole extends ModelBase
{
  ...
  public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    if(	Mole.worldObj.getBlockState(position).getBlock() == Blocks.dirt || Mole.worldObj.getBlockState(position).getBlock() == Blocks.grass|| Mole.worldObj.getBlockState(position).getBlock() == Blocks.sand)
    {
    if(!Mole.isSprinting())
    {
    	Shape1.render(f5);
