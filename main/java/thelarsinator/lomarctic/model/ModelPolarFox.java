...
public class ModelPolarFox extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.wolfTail.rotateAngleX = 45 + MathHelper.sin(ageInTicks/50)/10;
        //System.out.println(MathHelper.sin(ageInTicks/50));
    }
}