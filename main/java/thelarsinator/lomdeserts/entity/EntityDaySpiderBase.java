...
{
    private static final DataParameter<Byte> CLIMBING = EntityDataManager.<Byte>createKey(EntityDaySpiderBase.class, DataSerializers.BYTE);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(4, new EntityDaySpiderBase.AISpiderAttack(this));
        this.tasks.addTask(5, new EntityAIWander(this, 0.8D));
        this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
        this.tasks.addTask(6, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false, new Class[0]));
        this.targetTasks.addTask(2, new EntityDaySpiderBase.AISpiderTarget(this, EntityPlayer.class));
        this.targetTasks.addTask(3, new EntityDaySpiderBase.AISpiderTarget(this, EntityIronGolem.class));
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        if (livingdata == null)
        {
            livingdata = new EntityDaySpiderBase.GroupData();
            ...
            {
                ((EntityDaySpiderBase.GroupData)livingdata).func_111104_a(this.worldObj.rand);
            }
        }

        if (livingdata instanceof EntityDaySpiderBase.GroupData)
        {
            Potion potion = ((EntityDaySpiderBase.GroupData)livingdata).field_188478_a;
    ...
    static class AISpiderAttack extends EntityAIAttackMelee
        {
            public AISpiderAttack(EntityDaySpiderBase spider)
            {
    ...
    static class AISpiderTarget<T extends EntityLivingBase> extends EntityAINearestAttackableTarget<T>
        {
            public AISpiderTarget(EntityDaySpiderBase spider, Class<T> classTarget)
            {
